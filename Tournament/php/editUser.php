...
if(isset($_POST["id"]) && !empty($_POST["id"])) {
    ...
    if(empty($name_err) && empty($email_err) ) {
        $sql = "UPDATE user_details SET first=:first, middle=:middle, last=:last WHERE id=:id";
        if ($stmt = $conn->prepare($sql)) {
            ...
            if ($stmt->execute()) {
                $update = "UPDATE users inner join user_details ON users.id = user_details.fkuser  SET email=:email WHERE user_details.id=:id";
        ...
        <div class="col-6 mx-auto"><!--right col-->
            <div class="tab-content">
                <div class="tab-pane active">
                    <h3 class="text-center" style="color: cornflowerblue">Scheidsrechters bewerken:</h3>
                    <hr>
                    <form action="" method="post">
                        <div class="form-group">
                            <div class="col-xs-6">
                                <label for="name"><h5>Naam scheidsrechters:</h5></label>
                                <div class="col p-2">
                        ...
                        <div class="form-group">
                            <div class="col-xs-6">
                                <label for="name"><h5>Email scheidsrechters:</h5></label>
